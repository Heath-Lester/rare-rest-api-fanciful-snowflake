# Generated by Django 3.1.6 on 2021-02-24 16:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='authtoken.token')),
                ('follower', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subscriber', to='authtoken.token')),
            ],
        ),
        migrations.CreateModel(
            name='PostTag',
